...
.theme--dark.v-application {
  ...
  background: linear-gradient(55deg, rgba(0,0,0,1) 0%, rgba(7,55,82,1) 10%, rgba(9,97,116,1) 51%, rgba(7,55,82,1) 92%, rgba(0,0,0,1) 100%);
...
.v-snack__wrapper.theme--dark {
  ...
  font-style: normal;
  background: linear-gradient(270deg, #073752, #4c00e6, #16bd24, #14fff6, #bf14ff, #ff1414);
