...
export default {
  ...
  methods: {
    ...
    async mostrar() {
      try {
        const res = await fetch("http://192.168.1.210:3001/actmantt");
    ...
    async enviarForm() {
      const res = await fetch("http://192.168.1.210:3001/insertarMante", {
        method: "POST",
        headers: {
    ...
    async actualiarDes() {
      const res = await fetch("http://192.168.1.210:3001/actualizarDesinsum", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
