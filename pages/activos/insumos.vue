...
export default {
  ...
  methods: {
    ...
    async mostrar() {
      try {
        const res = await fetch("http://192.168.1.31:3001/insumos");
    ...
    async submitForm() {
      ...
      const res = await fetch("http://192.168.1.31:3001/insertarInsumos", {
        method: "POST",
        headers: {
    ...
    async actualizaracti() {
      const res = await fetch("http://192.168.1.31:3001/actualizarInsumos", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
