<template>
  <v-app
    style="
      background: url('https://res.cloudinary.com/rey/image/upload/fl_preserve_transparency/v1726776633/1708975406243-Screenshot_20240108_105009_cnfrg0.jpg?_s=public-apps')
        no-repeat;
  ...
  >
      ...
      <v-col style="max-width: 70%">
        <v-card style="background-color: rgba(7, 55, 82, 0.25)">
          ...
          <v-card-text>
            ...
            <v-btn
              block
              style="background-color: rgba(7, 55, 82)"
              cols="12"
              sm="6"
              md="4"
              @click="enviarL"
    ...
    <v-footer app style="background-color: rgba(7, 55, 82, 0.9); text-align: center">
